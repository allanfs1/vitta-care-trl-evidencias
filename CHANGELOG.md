...
## [v0.4.0] — 2026-09
### Adicionado
- Evidências completas de avaliação e primeiros testes da I.A. preditiva (`evidencias/resultados-ia-preditiva/`), incluindo 15 gráficos diagnósticos (ROC, PR, Lift, Gain, KS, Calibração, Distribuição de Probabilidades e SHAP).
